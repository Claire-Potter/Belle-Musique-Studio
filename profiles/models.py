...
# The Signal class allows certain senders to notify a set of receivers that some action
...
class UserProfile(models.Model):
    ...
    default_email = models.EmailField(default='', max_length=254,
                                      null=True, blank=True)
    default_additional_email = models.EmailField(default='', max_length=254, null=True, blank=True)
