...
The SubscribedCustomer model is where a user's details are saved
as a customer record. This includes the customer details,
user details and contact details.

The SubscribedLineItem model is where a subscribed customer's
subscription details are saved as a subscription record. This includes
the subscription details and billing details.
...
# The Django settings file contains all of the
# configuration for a web application.
from django.db import models
# models is a callable within the django.db module of the Django project
from django.db.models import Sum
# One of the ways that aggregate values can be generated and returned
# using Django queries.
...
#  :text=A%20Django%20application%20that%20provides,Installation)
...
class OrderLineItem(models.Model):
    ...
    product = models.ForeignKey(MusicProduct, null=False, blank=False,
                                on_delete=models.CASCADE)
